...
export default function KeywordFilter({
  ...
  return (
    <div className="relative max-w-3xl mx-auto mt-2 h-8 hidden sm:block">
      ...
      >
        <div className="inline-flex gap-2 px-2 pb-3">
          {keywords.map((keyword) => {
            ...
            return (
              <motion.button
                ...
                className={`inline-flex items-center px-3 h-7 rounded-full text-sm transition-all
                  ${isSelected 
